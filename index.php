			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Featured Products</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					...
					<li><a href="#painting" data-toggle="tab">Painting</a></li>
					<li><a href="#sculpture" data-toggle="tab">Sculpture</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
...
?>
	...
	<div class="tab-pane" id="painting">
					<div class="product-slider">
				...
				<div class="row">
					<div class="col-md-6">
	                   <section class="section">
	                   	<h3 class="section-title">Graphic Cards</h3>
	                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	   
<?php
$ret=mysql_query("select * from products where category=12");
while ($row=mysql_fetch_array($ret)) 
{
?>
...
<?php }?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">Hard Disk</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
$ret=mysql_query("select * from products where category=15");
while ($row=mysql_fetch_array($ret)) 
{
?>
...
<?php }?>
	...
	<section class="section featured-product inner-xs wow fadeInUp">
		...
		<div class="owl-carousel best-seller custom-carousel owl-theme outer-top-xs">
			<?php
$ret=mysql_query("select * from products where category=14");
while ($row=mysql_fetch_array($ret)) 
{
	# code...
